  ...
  return (
    <section id="about" className="py-20 px-4">
      <div className="container mx-auto max-w-4xl">
        ...
        <div
          ref={ref}
          className={`section-reveal jarvis-panel p-8 md:p-12 font-rajdhani text-lg leading-relaxed text-foreground space-y-4 ${revealed ? "revealed" : ""}`}
        >
          <p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6 font-mono text-sm">
            {[
